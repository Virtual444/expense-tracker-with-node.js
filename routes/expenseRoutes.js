...
const downloadExpenseController = require('../controllers/downloadExpenseController');
...
router.post('/expenses/download-expense',authenticateToken, downloadExpenseController.downloadExpense);
router.get('/expenses/download-expense-history',authenticateToken, downloadExpenseController.showDownloadHistory);
