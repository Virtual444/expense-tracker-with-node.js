...
sendSmtpEmail.htmlContent =  `<html><body><h1>Click below to reset your password</h1><a href="https://facebook.com">Click Here</a></body></html>`;
sendSmtpEmail.sender =  {"name": "Expense Tracker", "email": "asitpal211@gmail.com"};
sendSmtpEmail.to = [
  { "email": email }
];
    
    transEmailApi.sendTransacEmail(sendSmtpEmail)
    .then((sendinBlueResponse) => {
        console.log('nikhil');
        console.log(sendinBlueResponse);
